                            ...
                            <div class="game_info">
                                ...
                                <div v-dragscroll="true" class="r_bk">
                                    <ul class="games_status_list">
                                        <li :class="{ hand : game.games_status.length > 3 }" v-for="(status, index) in game.games_status" :key="index">
...
.tablet_content .main_menu {
    background: #f5f6fa;
}
.tablet_content .main_menu ul {
    display: flex;
    list-style: none;
...
.tablet_content .main_menu ul li a{
...
.tablet_content .main_menu ul li a:hover {
...
.race_of_games .game_situation .player span {
    font-size: 1.1rem;
}
...
.game_info .l_bk .player .player_info span {
  font-size: 1.1em;
}
